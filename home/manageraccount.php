                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <input type="email" class="form-control" id='email' rules="required|email" placeholder="Email" name='email' value="<?php echo $sql[0]['email']?>">
                    ...
                    <div class="form-group col-md-4">
                            <select name="day" id="day" class="custom-select">
                                <?php
                                    for($i = 1 ; $i <= 31;$i++):
                                ?>
                                <option <?php if($i == $days[0]){echo "selected";}?> value="<?php echo $i ?>" <?php $i == abs(date("d")) ? "selected" : '' ?>><?php echo $days[0] ?></option>
                            <?php endfor; ?>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
